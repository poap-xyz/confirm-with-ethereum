...
var _require = require('./helpers'),
  eth_address_regex = _require.eth_address_regex,
  log = _require.log,
  normalize_string = _require.normalize_string,
  commented_text = _require.commented_text;
...
*/
export default function sign_action(_x, _x2, _x3) {
  return _sign_action.apply(this, arguments);
}
function _sign_action() {
  _sign_action = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(action, signer, message_prompt) {
    var add_timestamp,
      address,
      stringified_action,
      claimed_message,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          add_timestamp = _args.length > 3 && _args[3] !== undefined ? _args[3] : true;
          if (action) {
            _context.next = 3;
            break;
          }
          throw new Error("Please specify what action you want signed");
        case 3:
          ...
          throw new Error("No signer specified, are you connected to your wallet?");
        case 7:
          _context.next = 9;
        ...
        case 9:
          ...
          throw new Error("Please specify what address you expect to sign this message");
        case 12:
        ...
        case 22:
          ...
          stringified_action = JSON.stringify(action, null, 2);
          ...
          _context.next = 29;
          return signer.signMessage(claimed_message);
        case 29:
          ...
          return _context.abrupt("return", formatted_signature);
        case 33:
        case "end":
